...
const Instructions = () => {
  return (
    <div class="pl-60 mb-5 flex flex-col">
      <h2 class="font-bold text-2xl mb-6">Instructions</h2>
      <div class="mb-5 flex items-start">
        <span class="rounded-md bg-orange-400 text-white mr-2">
          <div class="flex justify-center shrink-0 object-cover w-6 h-6">1</div>
        </span>
        <p>
      ...
      <div class="mb-5 flex items-start">
        <span class="rounded-md bg-orange-400 text-white mr-2">
          <div class="flex justify-center shrink-0 object-cover w-6 h-6">2</div>
        </span>
        <p>
      ...
      <div class="mb-5 flex items-start">
        <span class="flex items-s justify-center w-6 h-6 rounded-md bg-orange-400 text-white mr-2">
          <div class="flex justify-center shrink-0 object-cover w-6 h-6">3</div>
        </span>
        <p>
      ...
      <div class="mb-5 flex items-start">
        <span class="inline-flex items-s justify-center w-6 h-6 rounded-md bg-orange-400 text-white mr-2">
          <div class="flex justify-center shrink-0 object-cover w-6 h-6">4</div>
        </span>
        <p>
      ...
      <div class="mb-5 flex items-start">
        <span class="inline-flex items-s justify-center w-6 h-6 rounded-md bg-orange-400 text-white mr-2">
          <div class="flex justify-center shrink-0 object-cover w-6 h-6">5</div>
        </span>
        <p>
      ...
      <div class="mb-5 flex items-start">
        <span class="flex items-s justify-center w-6 h-6 rounded-md bg-orange-400 text-white mr-2">
          <div class="flex justify-center shrink-0 object-cover w-6 h-6">6</div>
        </span>
        <p>
          {" "}
      ...
      <div class="mb-3 flex items-starts">
        <span class="flex items-s justify-center w-6 h-6 rounded-md bg-orange-400 text-white mr-2">
          <div class="flex justify-center shrink-0 object-cover w-6 h-6">7</div>
        </span>
        <p>
